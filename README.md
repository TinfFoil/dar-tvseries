...
3. [Preprocessing_and_models.ipynb](https://github.com/TinfFoil/dar_tvseries/blob/main/preprocessing_and_baseline.ipynb): preprocessing and training some models on the data from season_data_preparation.ipynb.
4. Report

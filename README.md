...
3. [Preprocessing_and_baseline.ipynb](https://github.com/TinfFoil/dar_tvseries/blob/main/preprocessing_and_baseline.ipynb): preprocessing the text and training a model on the data from season_data_preparation.ipynb.
4. Report
